...
const recipeBook = {
  ...
  "kimchi fried rice": {
    ...
    steps: ["Chop kimchi.", "Sauté with rice and garlic.", "Add gochujang and egg."]
  },
  "biryani": {
    origin: "India",
    description: "Spiced rice layered with meat.",
    steps: ["Marinate meat.", "Cook basmati rice.", "Layer with spices.", "Steam until aromatic."]
  },
  "empanadas": {
    origin: "Latin America",
    description: "Stuffed pastry turnovers.",
    steps: ["Prepare dough.", "Make filling.", "Fill and seal.", "Bake or fry."]
  },
  "pho": {
    origin: "Vietnam",
    description: "Beef noodle soup with herbs.",
    steps: ["Boil bones for broth.", "Add spices.", "Cook rice noodles.", "Assemble with beef and herbs."]
  },
  "beef stroganoff": {
    origin: "Russia",
    description: "Beef in creamy mushroom sauce.",
    steps: ["Sauté beef and onions.", "Add mushrooms.", "Stir in sour cream.", "Serve over noodles."]
  },
  "laksa": {
    origin: "Malaysia/Singapore",
    description: "Spicy coconut noodle soup.",
    steps: ["Make laksa paste.", "Boil with coconut milk.", "Add noodles and toppings."]
  },
  "tacos al pastor": {
    origin: "Mexico",
    description: "Marinated pork tacos with pineapple.",
    steps: ["Marinate pork.", "Grill on spit.", "Slice and serve on tortillas."]
  },
  "chicken tikka masala": {
    origin: "UK/India",
    description: "Grilled chicken in tomato cream sauce.",
    steps: ["Marinate and grill chicken.", "Simmer sauce.", "Combine and serve."]
  },
  "okonomiyaki": {
    origin: "Japan",
