We use discord.js and JavaScript for Node.js to create a Discord bot.

Commands in our bot are JavaScript files-modules that have the following public API:
...
Export items using the following syntax:
...
Here's an example of a command module:
...
Write a command module that that ...
